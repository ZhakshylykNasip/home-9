...
const Expenses = ({ newExpense, deleteExpense}) => {
  ...
  return (
    <ExpensesStyled>
      ...
      <div>
        {sortExpense
          ? descending.map((el) => <ExpensesCard key={el.id} el={el} deleteExpense={deleteExpense} />)
          : ascending.map((el) => <ExpensesCard key={el.id} el={el}deleteExpense={deleteExpense} />)}
      </div>
    </ExpensesStyled>
  )
}
